...
void showDetails(BuildContext context, SalaryResultModel salary) {
  ...
  final double shiftPrice =
      isMarketing ? (hourRate * shiftHoursMarketing) : (hourRate * shiftHours);
      ...
      child: Align(
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(
            maxWidth: Responsive.isDesktop(context) ? 980 : double.infinity,
          ),
          child: Container(
                ...
                children: [
                  ...
                  ...{
                    ...
                    final Color textColor =
                        isDeduction ? Colors.red : Colors.black;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (Salarydetails.lateCount.total > 0)
                          Padding(
                            padding:
                                const EdgeInsets.only(right: 24.0, bottom: 4),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                        ...
                        CommitmentDetailRow(
                          label: "الجزائات",
                          value:
                              Salarydetails.penaltiesCount.toStringAsFixed(0),
                          isSuccess: isMarketing
                              ? null
